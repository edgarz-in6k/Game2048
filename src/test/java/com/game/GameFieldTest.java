...
public class GameFieldTest {
    ...
    @Test
    public void testHasAvailableMovesFalse(){
        GameField gameField = new GameField(new StaticProgressiveCellValueFiller(new StaticProgressiveCellValueGenerator()), size);
        //2 4 8 16
        //32 64 128 256
        //512 1024 2048 4096
        ...
        for (int i = 0; i < 16; i++)
            gameField.fillEntryCell();
        Assert.assertEquals(gameField.hasAvailableMoves(), false);
    }

    @Test
    public void testHasAvailableMovesTrue() {
        GameField gameField = new GameField(new StaticCellValueFiller(new StaticCellValueGenerator()), size);
        //2222
        //2222
        //2222
        ...
        for (int i = 0; i < 14; i++)
            gameField.fillEntryCell();
        Assert.assertEquals(gameField.hasAvailableMoves(), true);
    }

    @Test
    public void testHasCellWith2048True(){
        GameField gameField = new GameField(new StaticProgressiveCellValueFiller(new StaticProgressiveCellValueGenerator()), size);
        //2 4 8 16
        //32 64 128 256
        //512 1024 2048 4096
        ...
        for (int i = 0; i < 16; i++)
            gameField.fillEntryCell();
        Assert.assertEquals(gameField.hasCellWith2048(), true);
    }

    @Test
    public void testHasCellWith2048False() {
        GameField gameField = new GameField(new StaticCellValueFiller(new StaticCellValueGenerator()), size);
        //2222
        //2222
        //2222
        ...
        for (int i = 0; i < 14; i++)
            gameField.fillEntryCell();
        Assert.assertEquals(gameField.hasCellWith2048(), false);
    }
}